		...
		<table class="table table-striped table-bordered table-hover" id="articleList">
			<thead>
				<tr>
					...
					<th class="name">
						<?php echo JHtml::_('grid.sort',  'COM_JAB_SPEAKER_NAME_LABEL', 's.name', $listDirn, $listOrder); ?>
					</th>
					<th width="10%" class="center">
						<?php echo JHtml::_('grid.sort',  'JPUBLISHED', 's.state', $listDirn, $listOrder); ?>
					</th>
					<th width="10%" class="center">
						<?php echo JHtml::_('grid.sort', 'JGRID_HEADING_LANGUAGE', 'language', $listDirn, $listOrder); ?>
					</th>
					<th width="1%" class="id center">
						<?php echo JHtml::_('grid.sort',  'COM_JAB_ID', 's.id', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
