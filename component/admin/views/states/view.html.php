 ...
 * @since       1.0
 */
class JabViewStates extends JViewLegacy
{
	/**
	 * Display method
	 *
	...
	protected function addToolbar()
	{
		...
		{
			// Page title
			JToolBarHelper::title(JText::_('COM_JAB_STATE_LIST_TITLE'), 'article.png');

			// Back button
			JToolBarHelper::custom('states.topanel', 'back.png', 'back_f2.png', 'COM_JAB_CONTROL_PANEL_TITLE', false);
