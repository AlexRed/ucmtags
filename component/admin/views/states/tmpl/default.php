		...
		<table class="table table-striped table-bordered table-hover" id="articleList">
			<thead>
				<tr>
					...
					<?php endif; ?>
					<th class="name">
						<?php echo JHtml::_('grid.sort',  'COM_JAB_NAME_LABEL', 'st.name', $listDirn, $listOrder); ?>
					</th>
					<th width="5%">
						<?php echo JHtml::_('grid.sort',  'JPUBLISHED', 'st.active', $listDirn, $listOrder); ?>
					</th>
					<th width="10%" class="center">
						<?php echo JHtml::_('grid.sort', 'JGRID_HEADING_LANGUAGE', 'language', $listDirn, $listOrder); ?>
					</th>
					<th width="1%" class="id">
						<?php echo JHtml::_('grid.sort',  'COM_JAB_ID', 'st.id', $listDirn, $listOrder); ?>
					</th>
				</tr>
			</thead>
			<tfoot>
