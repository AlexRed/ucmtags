 ...
 * @since       1.0
 */
class JabViewCountry extends JViewLegacy
{
	/**
	 * Display method
	 *
	...
	protected function addToolbar()
	{
		...
		// Set Toolbar title
		JToolBarHelper::title(JText::_('COM_JAB_COUNTRY_FORM_TITLE'), 'article.png');
		...
		if ($user->authorise('core.admin', 'com_jab.panel'))
		{
			...
			JToolBarHelper::custom('country.save2new', 'save.png', 'save_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
		}
