...
class JabViewSpeaker extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		// Set Toolbar title
		JToolBarHelper::title(JText::_('COM_JAB_SPEAKER_FORM_TITLE'), 'article.png');
		...
		if ($user->authorise('core.admin', 'com_jab.panel'))
		{
			...
			JToolBarHelper::custom('speaker.save2new', 'save.png', 'save_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
		}
