 ...
 * @since       1.0
 */
class JabControllerSpeaker extends JControllerForm
{
	/**
	 * @var    string  The prefix to use with controller messages.
	 * @since  1.0
	 */
	protected $text_prefix = 'COM_JAB_SPEAKER';
	 ...
	 */
	public function getModel($name = 'Speaker', $prefix = 'JabModel', $config = array('ignore_request' => true))
	{
