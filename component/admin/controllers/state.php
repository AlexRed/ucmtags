 ...
 * @since       1.0
 */
class JabControllerState extends JControllerForm
{
	/**
	 * @var    string  The prefix to use with controller messages.
	 * @since  2.5
	 */
	protected $text_prefix = 'COM_JAB_STATE';
	 ...
	 */
	public function getModel($name = 'State', $prefix = 'JabModel', $config = array('ignore_request' => true))
	{
