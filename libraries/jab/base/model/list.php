 ...
 *
 * @package     Jab.Libraries
 * @subpackage  Base.Models.List
 *
 * @since       1.0.0
 */
abstract class JabBaseModelList extends JModelList
{
	/**
	 * Delete items
	 *
	...
	protected function loadForm($name, $source = null, $options = array(), $clear = false, $xpath = false)
	{
		...
		JFormHelper::addFieldPath(JPATH_LIBRARIES . '/jab/fields');
		JFormHelper::addRulePath(JPATH_LIBRARIES . '/jab/form/rules');

		try
		{
			$form = JabForm::getInstance($name, $source, $options, false, $xpath);
