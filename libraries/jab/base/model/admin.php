...
/**
 * JAB Base Model Admin
 *
 * @package     Jab.Libraries
 * @subpackage  Base.Models.Admin
 *
 * @since       1.0.0
 */
class JabBaseModelAdmin extends JModelAdmin
{
	/**
	 * Component name
	 *
	 ...
	 * @return JTable
	 */
	public function getTable($type = 'none', $prefix = 'JabTable', $config = array())
	{
