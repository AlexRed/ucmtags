 ...
 * @since       1.0
 */
class JabBaseTable extends JTable
{
	/**
	 ...
	 * @var  string
	 */
	protected $_logPrefix = 'jab';

	/**
	 * The table name without the prefix. Ex: jab_speakers
	 *
	 * @var  string
	 */
	...
	public function __construct(&$db)
	{
		...
		if (empty($this->_tbl) || empty($this->_tbl_key))
		{
			...
			JLog::add(JText::sprintf('COM_JAB_ERROR_INITIALIZING_TABLE', $this->_tbl, $this->_tbl_key), JLog::ERROR, $this->_logPrefix . 'Tables');
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		catch (RuntimeException $e)
		{
			...
			JLog::add(JText::sprintf('COM_JAB_ERROR_QUERY', $db->dump()), JLog::ERROR, $this->_logPrefix . 'Queries');
